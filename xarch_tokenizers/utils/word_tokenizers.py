...
from xarch_tokenizers.utils._import_utils import ASSETS_PATH, check_required_dependencies
from xarch_tokenizers.utils.text import TERMINAL_PUNCTUATION
...
class SpaCyTokenizer(WordTokenizer):
    ...
    def tokenizer(self):
        if self._tokenizer is None:
            ...
            from xarch_tokenizers.utils.japanese_tokenizer import JapaneseTokenizer  # noqa: F401
